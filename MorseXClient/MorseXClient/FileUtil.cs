...
namespace MorseXClient
{
    class FileUtil
    {
        public static string ApplicationPath = System.Environment.CurrentDirectory;
        public static string DotSoundPath = ApplicationPath + @"\Dot.wav";
        public static string DashSoundPath = ApplicationPath + @"\Dash.wav";
        /// <summary>
        /// 从资源文件中抽取资源文件
        /// </summary>
